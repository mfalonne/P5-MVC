...
class __TwigTemplate_cd990d1ad03b29ee237af96c08f4afaf extends Template
{
    private $source;
    private $macros = [];
    ...
    <form action=\"";
      ...
      <div class=\"form-group mb-3\">
        ...
        <textarea name=\"content\"
          ...
          ";
        // line 30
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["post"] ?? null), "content", [], "any", false, false, false, 30), "html", null, true);
        yield "
        </textarea>
      </div>
...
";
    ...
    {
        return array (  103 => 36,  101 => 34,  94 => 30,  81 => 20,  70 => 12,  65 => 10,  61 => 8,  57 => 7,  48 => 3,  37 => 1,);
    }
...
{% endblock %}
", "dashboard/edit_post.twig", "C:\\xampp\\htdocs\\MVC-exemple\\views\\dashboard\\edit_post.twig");
    }
}
